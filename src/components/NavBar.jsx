...
export default function NavBar() {
  ...
  const hasVectorSelection =
    state.vector.currentIndex !== null || state.vector.selectedIndices.size > 0
  ...
  const canFlipRotate = hasPaste || hasVectorSelection
  ...
  const showOptions = ['curve', 'ellipse', 'polygon', 'select'].includes(
    toolName,
  )
  ...
  function handleImport(e) {
    ...
    reader.onload = (ev) => {
      ...
      img.onload = () => {
        ...
        state.clipboard.select.imageData = ctx.getImageData(
          0,
          0,
          img.width,
          img.height,
        ...
        >
          ...
          >
            ...
            <ul role='menu' id='file-submenu'>
              ...
              <li
                role='menuitem'
                className={`import-image${hasPaste ? ' disabled' : ''}`}
              >
                <label htmlFor='import' data-tooltip='Import image'>
                  Import
                </label>
                <input
                  type='file'
          ...
          >
            ...
            <ul role='menu' id='edit-submenu'>
              ...
              <li
                ...
                onClick={
                  canFlipRotate ? () => actionFlipPixels(true) : undefined
                }
              >
              ...
              <li
                ...
                onClick={
                  canFlipRotate ? () => actionFlipPixels(false) : undefined
                }
              >
            ...
            {Object.entries(toolOptions).map(([optionName, option]) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleOptionChange(optionName, e.target.checked)
                  }
                />
